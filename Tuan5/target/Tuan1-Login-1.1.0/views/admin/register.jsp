				...
				<div class="card shadow-lg border-0 rounded-lg mt-5">
					...
					<div class="card-body">
						<form>
							...
							<div class="mt-4 mb-0">
								<div class="d-grid">
									<a class="btn btn-primary btn-block" href="${pageContext.request.contextPath}/admin?page=login">Create
										Account</a>
								</div>
							</div>
						</form>
					...
					<div class="card-footer text-center py-3">
						<div class="small">
							<a href="${pageContext.request.contextPath}/admin?page=login">Have an account? Go to login</a>
						</div>
					</div>
				</div>
			</div>
